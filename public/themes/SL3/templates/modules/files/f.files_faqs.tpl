<div class="col-xl-12 col-lg-12 col-md-12 col-sm-12 col-12">
   <h2 class="h4 p-3 bg-light text-center">FAQs para la secci&oacute;n de archivos de <b>{$tsConfig.titulo}</b></h2>
   <div class="row">
      ...
      <div class="col-xl-9 col-lg-9 col-md-9 col-sm-12 col-12">
         <h2 class="h4 p-2" id="aviso_de_copyright">Aviso de Copyright</h2>
         <p class="lead"><b>{$tsConfig.titulo}</b> respeta los derechos de propiedad de terceros y requiere que los usuarios del servicio de archivos de <b>{$tsConfig.titulo}</b> acepten a su vez las leyes respecto al copyright. Se proh&iacute;be estrictamente utilizar el servicio de archivos de <b>{$tsConfig.titulo}</b> para infringir dichos derechos de propiedad. No debes subir, descargar, compartir, mostrar, hacer streaming, distribuir, enviar por e-mail, enlazar, transmitir o proporcionar ning&uacute;n archivo que infrinja cualquier copyright o derecho de autor de cualquier persona o entidad.</p>
         <hr />
         <h2 class="h4 p-2" id="faqs_1">¿Qu&eacute; archivos puedo cargar y almacenar?</h2>
         <p class="lead">Puedes subir todos los archivos que cumplen con nuestros T&eacute;rminos y Condiciones. Por favor no subir cualquier material pornogr&aacute;fico, violento o derechos de autor. Aceptamos todos los tipos de archivo para la carga.</p>
         <hr />
         <h2 class="h4 p-2" id="faqs_2">¿Cuantos archivos puedo subir y que tama&ntilde;o permite?</h2>
         <p class="lead"><b>{$tsConfig.titulo}</b> te permite subir todos los archivos que desees pero solo uno a la vez. Para cada archivo tiene un l&iacute;mite de subida de hasta {$tsConfig.c_max_upload}Mb.</p>
         <hr />
