			...
			success: function(h){
				switch(h.charAt(0)){
					...
					case '1': //OK
						...
						$(obj).children().attr({'src': global_data.images + '/reactivar.png',
																		'title': 'Reactivar',
																		'alt': 'reactivar'
																	});
			...
			success: function(h){
				switch(h.charAt(0)){
					...
					case '1': //OK
						...
						$(obj).children().attr({'src': global_data.images + '/borrar.png',
																		'title': 'Borrar',
																		'alt': 'Borrar'
																	});
