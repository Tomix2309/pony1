...
(() => {
   ...
   const loaderNavegationFixed = () => {
      ...
      let scroll = ($(window).scrollTop() >= 185);
      $(".navbar.navbar-expand-lg")[(scroll ? 'addClass' : 'removeClass')]('sticky-top');
      $('.navbar-brand')[(scroll ? 'fadeIn' : 'fadeOut')](300);
   }
...
$(document).on('keydown', event => {
   if (event.key === 'D' && event.shiftKey) modechange();
      ...
      steps: [
         {
            ...
            popover: {
               ...
               description: 'Haciendo clic sobre la imagen, vas a poder cambiar tu avatar o seleccionar una ya predefinida por ' + global_data.titulo,
               position: 'bottom'
            }
         }, {
            element: '#publicar',
