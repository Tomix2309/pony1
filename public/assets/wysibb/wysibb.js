...
//			direction:			"ltr",
			...
			buttons: "bold,italic,underline,strike,sup,sub,|,img,video,link,|,fontcolor,fontsize,fontfamily,|,smileBox,bullist,numlist,|,justifyleft,justifycenter,justifyright,justify,|,hr,quote,code,thumbnails,|,removeFormat",
			allButtons: {
				bold : {
					title: CURLANG.bold,
				...
				thumbnails: {
					title: CURLANG.thumbnails,
					buttonHTML: '<i data-feather="grid"></i>',
					transform: {
						'<div class="thumbnails">{SELTEXT}</div>':"[thumbnails]{SELTEXT}[/thumbnails]"
					}
				},
				link : {
					title: CURLANG.link,
				...
				video: {
					...
					modal: {
						...
						onSubmit: function(cmd,opt,queryState) {
							...
							var a;
							if (url.indexOf("youtu.be")!=-1) a = url.match(/^http[s]*:\/\/youtu\.be\/([a-z0-9_-]+)/i);
							else a = url.match(/^http[s]*:\/\/www\.youtube\.com\/watch\?.*?v=([a-z0-9_-]+)/i);
							if (a && a.length==2) {
								var code = a[1];
					...
					transform: {
						'<iframe src="https://www.youtube.com/embed/{SRC}" width="100%" height="360" frameborder="0" allowfullscreen></iframe>':'[video=https://www.youtube.com/v/{SRC}]'
					}
				},
				//select options
				fs_verysmall: {
			...
			smileList: [
				// SMILES DEFAULT
				{title: ":)", img: '<img src="'+global_data.images+'smiles/001.png">', bbcode:":)"},
				{title: ":D", img: '<img src="'+global_data.images+'smiles/002.png">', bbcode:":D"},
				{title: ";)", img: '<img src="'+global_data.images+'smiles/003.gif">', bbcode:";)"},
				{title: ":O", img: '<img src="'+global_data.images+'smiles/004.png">', bbcode:":O"},
				{title: "(H)", img: '<img src="'+global_data.images+'smiles/006.png">', bbcode:"(H)"},
				{title: ":P", img: '<img src="'+global_data.images+'smiles/104.png">', bbcode:":P"},
				{title: "8o|", img: '<img src="'+global_data.images+'smiles/049.png">', bbcode:"8o|"},
				{title: ":S", img: '<img src="'+global_data.images+'smiles/009.png">', bbcode:":S"},
				{title: ":$", img: '<img src="'+global_data.images+'smiles/008.png">', bbcode:":$"},
				{title: ":(", img: '<img src="'+global_data.images+'smiles/010.png">', bbcode:":("},
				{title: ":'(", img: '<img src="'+global_data.images+'smiles/011.gif">', bbcode:":'("},
				{title: ":|", img: '<img src="'+global_data.images+'smiles/012.png">', bbcode:":|"},
				{title: "(6)", img: '<img src="'+global_data.images+'smiles/013.png">', bbcode:"(6)"},
				{title: "8-|", img: '<img src="'+global_data.images+'smiles/050.png">', bbcode:"8-|"},
				{title: ":-/", img: '<img src="'+global_data.images+'smiles/083.png">', bbcode:":-/"},
				{title: "^o)", img: '<img src="'+global_data.images+'smiles/051.png">', bbcode:"^o)"},
				{title: "(A)", img: '<img src="'+global_data.images+'smiles/014.png">', bbcode:"(A)"},
				{title: ":[", img: '<img src="'+global_data.images+'smiles/043.png">', bbcode:":["},
				{title: ":-#", img: '<img src="'+global_data.images+'smiles/048.png">', bbcode:":-#"},
				{title: ":-*", img: '<img src="'+global_data.images+'smiles/052.png">', bbcode:":-*"},
				{title: "+o(", img: '<img src="'+global_data.images+'smiles/053.png">', bbcode:"+o("},
				{title: "(brb)", img: '<img src="'+global_data.images+'smiles/066.gif">', bbcode:"(brb)"},
				{title: ":^)", img: '<img src="'+global_data.images+'smiles/072.gif">', bbcode:":^)"},
				{title: "*-)", img: '<img src="'+global_data.images+'smiles/073.gif">', bbcode:"*-)"},
				{title: "<o)", img: '<img src="'+global_data.images+'smiles/075.gif">', bbcode:"<o)"},
				{title: "8-)", img: '<img src="'+global_data.images+'smiles/076.gif">', bbcode:"8-)"},
				{title: "|-)", img: '<img src="'+global_data.images+'smiles/078.gif">', bbcode:"|-)"},
				{title: ";-/", img: '<img src="'+global_data.images+'smiles/082.png">', bbcode:";-/"},
				{title: "(jk)", img: '<img src="'+global_data.images+'smiles/084.png">', bbcode:"(jk)"},
				{title: "(j)", img: '<img src="'+global_data.images+'smiles/086.png">', bbcode:"(j)"},
				{title: "(V)", img: '<img src="'+global_data.images+'smiles/087.png">', bbcode:"(v)"},
				{title: "(lol)", img: '<img src="'+global_data.images+'smiles/089.gif">', bbcode:"(lol)"},
				{title: "(xD)", img: '<img src="'+global_data.images+'smiles/090.png">', bbcode:"(xd)"},
				{title: ":8)", img: '<img src="'+global_data.images+'smiles/088.png">', bbcode:":8)"},
				{title: "(ff)", img: '<img src="'+global_data.images+'smiles/091.gif">', bbcode:"(ff)"},
				{title: "(fm)", img: '<img src="'+global_data.images+'smiles/092.gif">', bbcode:"(fm)"},
				{title: ":'|", img: '<img src="'+global_data.images+'smiles/093.gif">', bbcode:":'|"},
				{title: ":]", img: '<img src="'+global_data.images+'smiles/094.gif">', bbcode:":]"},
				{title: ":}", img: '<img src="'+global_data.images+'smiles/095.png">', bbcode:":}"},
				{title: "(BOO)", img: '<img src="'+global_data.images+'smiles/096.png">', bbcode:"(BOO)"},
				{title: "*|", img: '<img src="'+global_data.images+'smiles/097.gif">', bbcode:"*|"},
				{title: "*\\", img: '<img src="'+global_data.images+'smiles/098.png">', bbcode:"*\\"},
				{title: "(wm)", img: '<img src="'+global_data.images+'smiles/100.png">', bbcode:"(wm)"},
				{title: "(xo)", img: '<img src="'+global_data.images+'smiles/101.gif">', bbcode:"(xo)"},
				{title: "(l)", img: '<img src="'+global_data.images+'smiles/015.png">', bbcode:"(l)"},
				{title: "(u)", img: '<img src="'+global_data.images+'smiles/016.png">', bbcode:"(u)"},
				{title: "(@)", img: '<img src="'+global_data.images+'smiles/018.png">', bbcode:"(@)"},
				{title: "(&)", img: '<img src="'+global_data.images+'smiles/019.png">', bbcode:"(&)"},
				{title: "(S)", img: '<img src="'+global_data.images+'smiles/020.png">', bbcode:"(S)"},
				{title: "(*)", img: '<img src="'+global_data.images+'smiles/021.png">', bbcode:"(*)"},
				{title: "(~)", img: '<img src="'+global_data.images+'smiles/022.png">', bbcode:"(~)"},
				{title: "(8)", img: '<img src="'+global_data.images+'smiles/023.png">', bbcode:"(8)"},
				{title: "(E)", img: '<img src="'+global_data.images+'smiles/024.png">', bbcode:"(E)"},
				{title: "(F)", img: '<img src="'+global_data.images+'smiles/025.png">', bbcode:"(F)"},
				{title: "(W)", img: '<img src="'+global_data.images+'smiles/026.png">', bbcode:"(W)"},
				{title: "(O)", img: '<img src="'+global_data.images+'smiles/027.gif">', bbcode:"(O)"},
				{title: "(K)", img: '<img src="'+global_data.images+'smiles/028.png">', bbcode:"(K)"},
				{title: "(G)", img: '<img src="'+global_data.images+'smiles/029.png">', bbcode:"(G)"},
				{title: "(^)", img: '<img src="'+global_data.images+'smiles/030.png">', bbcode:"(^)"},
				{title: "(P)", img: '<img src="'+global_data.images+'smiles/031.png">', bbcode:"(P)"},
				{title: "(I)", img: '<img src="'+global_data.images+'smiles/032.png">', bbcode:"(I)"},
				{title: "(C)", img: '<img src="'+global_data.images+'smiles/033.png">', bbcode:"(C)"},
				{title: "(T)", img: '<img src="'+global_data.images+'smiles/034.png">', bbcode:"(T)"},
				{title: "({)", img: '<img src="'+global_data.images+'smiles/035.png">', bbcode:"({)"},
				{title: "(})", img: '<img src="'+global_data.images+'smiles/036.png">', bbcode:"(})"},
				{title: "(B)", img: '<img src="'+global_data.images+'smiles/037.png">', bbcode:"(B)"},
				{title: "(D)", img: '<img src="'+global_data.images+'smiles/038.png">', bbcode:"(D)"},
				{title: "(Z)", img: '<img src="'+global_data.images+'smiles/039.png">', bbcode:"(Z)"},
				{title: "(X)", img: '<img src="'+global_data.images+'smiles/040.png">', bbcode:"(X)"},
				{title: "(Y)", img: '<img src="'+global_data.images+'smiles/041.png">', bbcode:"(Y)"},
				{title: "(N)", img: '<img src="'+global_data.images+'smiles/042.png">', bbcode:"(N)"},
				{title: "(nnh)", img: '<img src="'+global_data.images+'smiles/044.png">', bbcode:"(nnh)"},
				{title: "(#)", img: '<img src="'+global_data.images+'smiles/046.png">', bbcode:"(#)"},
				{title: "(R)", img: '<img src="'+global_data.images+'smiles/047.png">', bbcode:"(R)"},
				{title: "(sn)", img: '<img src="'+global_data.images+'smiles/054.png">', bbcode:"(sn)"},
				{title: "(tu)", img: '<img src="'+global_data.images+'smiles/055.png">', bbcode:"(tu)"},
				{title: "(pl)", img: '<img src="'+global_data.images+'smiles/056.png">', bbcode:"(pl)"},
				{title: "(||)", img: '<img src="'+global_data.images+'smiles/057.png">', bbcode:"(||)"},
				{title: "(pi)", img: '<img src="'+global_data.images+'smiles/058.png">', bbcode:"(pi)"},
				{title: "(so)", img: '<img src="'+global_data.images+'smiles/059.png">', bbcode:"(so)"},
				{title: "(au)", img: '<img src="'+global_data.images+'smiles/060.png">', bbcode:"(au)"},
				{title: "(ap)", img: '<img src="'+global_data.images+'smiles/061.png">', bbcode:"(ap)"},
				{title: "(um)", img: '<img src="'+global_data.images+'smiles/062.png">', bbcode:"(um)"},
				{title: "(ip)", img: '<img src="'+global_data.images+'smiles/063.png">', bbcode:"(ip)"},
				{title: "(co)", img: '<img src="'+global_data.images+'smiles/064.png">', bbcode:"(co)"},
				{title: "(mp)", img: '<img src="'+global_data.images+'smiles/065.png">', bbcode:"(mp)"},
				{title: "(st)", img: '<img src="'+global_data.images+'smiles/067.png">', bbcode:"(st)"},
				{title: "(pu)", img: '<img src="'+global_data.images+'smiles/102.png">', bbcode:"(pu)"},
				{title: "(yn)", img: '<img src="'+global_data.images+'smiles/068.png">', bbcode:"(yn)"},
				{title: "(h5)", img: '<img src="'+global_data.images+'smiles/069.gif">', bbcode:"(h5)"},
				{title: "(mo)", img: '<img src="'+global_data.images+'smiles/070.png">', bbcode:"(mo)"},
				{title: "(bah)", img: '<img src="'+global_data.images+'smiles/071.png">', bbcode:"(bah)"},
				{title: "(li)", img: '<img src="'+global_data.images+'smiles/074.gif">', bbcode:"(lo)"},
				{title: "(wo)", img: '<img src="'+global_data.images+'smiles/077.png">', bbcode:"(wo)"},
				{title: "'.'", img: '<img src="'+global_data.images+'smiles/080.png">', bbcode:"'.'"},
				{title: "(bus)", img: '<img src="'+global_data.images+'smiles/045.png">', bbcode:"(bus)"},
				{title: "*p*", img: '<img src="'+global_data.images+'smiles/079.png">', bbcode:"*p*"},
				{title: "*s*", img: '<img src="'+global_data.images+'smiles/085.png">', bbcode:"*s*"},
				{title: "(M)", img: '<img src="'+global_data.images+'smiles/017.png">', bbcode:"(M)"},
				{title: "(xx)", img: '<img src="'+global_data.images+'smiles/103.png">', bbcode:"(xx)"},
				/* {title: ":CODIGO:", img: '<img src="'+global_data.images+'smiles/.gif">', bbcode:":CODIGO:"}, */
			],
		...
		imgLoadModal: function() {
			...
			if (this.options.imgupload===true) {
				...
				this.$modal.find("#fupform").on("submit",$.proxy(function(e) {
					$(e.target).parents("#imguploader").hide().after('<div class="loader"><img src="'+global_data.images+'wysibb/loader.gif" /><br/><br/><span>'+CURLANG.loading+'</span></div>').parent().css("text-align","center");
				},this))
