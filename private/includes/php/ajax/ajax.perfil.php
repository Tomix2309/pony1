...
\*********************************/
	...
	$files = array(
        ...
        'perfil-cambiar' => array('n' => 0, 'p' => 'cambiar'),
        'perfil-id' => array('n' => 0, 'p' => ''),
        'perfil-portada' => array('n' => 0, 'p' => ''),
	);
...
\*********************************/
	...
	switch($action){
        ...
        case 'perfil-id':
            //<---
            $smarty->assign("SL2User", $tsCuenta->getSettingsUser());
            //--->
        break;
        case 'perfil-portada':
            echo $tsCore->save_background('perfil');
        break;
        default:
