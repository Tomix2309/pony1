...
class tsUpload {
   ...
   public function copyFile($file, $name) {
      global $tsCore;
      // COPIAMOS
      copy($file['tmp_name'], ROUTEUPLOADS . $name);
      // REGRESAMOS LA URL
   ...
   public function cropAvatar(string $key = '') {
      ...
      $source = ROUTEUPLOADS . $this->prefix . $_POST['key'] . '.' . $_POST['ext'];
