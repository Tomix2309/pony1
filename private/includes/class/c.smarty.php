...
require(ROUTEGENERAL.DIRECTORY_SEPARATOR.'inc'.DIRECTORY_SEPARATOR.'smarty'.DIRECTORY_SEPARATOR.'Smarty.class.php');
...
class tsSmarty extends Smarty
{
  ...
  function __construct()
  {
    global $tsCore;
    //
    $this->template_dir = ROUTEGENERAL.DIRECTORY_SEPARATOR.'themes'.DIRECTORY_SEPARATOR.TS_TEMA.DIRECTORY_SEPARATOR.'templates';
    $this->compile_dir = ROUTEGENERAL.DIRECTORY_SEPARATOR.'cache'; 
