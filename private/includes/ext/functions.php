...
if(file_exists(ROUTEGENERAL . 'config.inc.php')) {
	require_once ROUTEGENERAL . 'config.inc.php';
...
function verify_data(array $fn = [], $columns, $table, $where) {
	return db_exec('num_rows', db_exec($fn, 'query', "SELECT $columns FROM $table WHERE $where"));
}
...
// Nuevas librer�as
include ROUTEEXTRAS . 'MobileDetect.php';