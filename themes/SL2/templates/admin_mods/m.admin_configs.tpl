    ...
    <fieldset>
        ...
        <dl>
         ...
         <dl>
            ...
            <dd><input type="text" id="ai_email" name="email" value="{$tsConfig.email}" /></dd>
         </dl>
         <dl>
            ...
            <dd>
               <select id="ai_idioma" name="idioma">
        ...
        <dl>
            ...
            <dd><input type="text" id="ai_edad" name="c_allow_edad" style="width:10%" maxlength="2" value="{$tsConfig.c_allow_edad}" /> a&ntilde;os.</dd>
        </dl>
		 <dl>
            ...
            <dd>
			<select id="ai_met_welcome" name="c_met_welcome" class="select" {if $tsConfig.c_met_welcome == 0} onchange="if($('#ai_met_welcome').val() != 0) $('textarea[name=message_welcome]').slideDown(); $('#desc_message_welcome').slideDown();" {/if}>
        ...
        <dl>
            ...
            <dd><input type="text" id="ai_active" name="c_last_active" style="width:10%" maxlength="2" value="{$tsConfig.c_last_active}" /> min.</dd>
        </dl>
        <dl>
            ...
            <dd><input type="text" id="ai_stats_cache" name="c_stats_cache" style="width:10%" maxlength="2" value="{$tsConfig.c_stats_cache}" /> min.</dd>
        </dl>
        <dl>
        ...
        <dl>
            ...
            <dd><input type="text" id="ai_max_nots" name="c_max_nots" style="width:10%" maxlength="3" value="{$tsConfig.c_max_nots}" /></dd>
        </dl>
        <dl>
            <dt><label for="ai_max_acts">M&aacute;ximo de actividades:</label><span>Cuantas actividades puede registrar un usuario.</span></dt>
            <dd><input type="text" id="ai_max_acts" name="c_max_acts" style="width:10%" maxlength="3" value="{$tsConfig.c_max_acts}" /></dd>
        </dl>
        <hr />
        <dl>
            ...
            <dd><input type="text" id="ai_max_post" name="c_max_posts" style="width:10%" maxlength="3" value="{$tsConfig.c_max_posts}" /></dd>
        </dl>
        <dl>
            ...
            <dd><input type="text" id="ai_max_com" name="c_max_com" style="width:10%" maxlength="3" value="{$tsConfig.c_max_com}" /></dd>
        </dl>
		<dl>
            ...
            <dd><input type="text" id="ai_allow_points" name="c_allow_points" style="width:10%" maxlength="3" value="{$tsConfig.c_allow_points}" /></dd>
        </dl>
        <dl>
