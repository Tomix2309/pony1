<div class="last_posts mb-3 position-relative w-100 text-white" itemscope itemtype="http://schema.org/CreateWork">
   <img src="{$tsConfig.images}/loadImage.gif" data-src="{$p.post_portada}" class="image portada w-100" loading="lazy" alt="{$p.post_title}">
   <span onclick="location.href='{$tsConfig.url}/posts/{$p.c_seo}/'" data-cat="{$p.c_nombre}" itemprop="genre"></span>
   <div class="data-info p-2 background__level--5 backdrop_filter--4">
