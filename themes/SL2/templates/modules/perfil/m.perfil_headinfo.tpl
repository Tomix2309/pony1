<div class="header__user bg-body-tertiary rounded">
   <div class="header__user--cover rounded shadow position-relative" style="background:linear-gradient(to bottom, transparent, transparent, #0002, #000D), url('{$tsPortada.url}');{$tsPortada.css}">
