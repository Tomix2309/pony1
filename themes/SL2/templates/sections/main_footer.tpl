		...
		<div class="row">
			<div class="col-md-5 mb-3">
				...
				<p class="position-relative py-3 pr-2">
					<img src="{$tsConfig.images}/loadImage.gif" data-src="{$tsImagenDes}" alt="{$tsConfig.titulo}" style="width: 4rem;height: 4rem;" class="image avatar img-fit-cover rounded me-3 float-start">                
					{$tsFooterDes}
				</p>
			</div>
...
{jsdelivr type='scripts' sources=['bootstrap','feather-icons','iconify-icon','driver.js','vanilla-lazyload','croppr','pace-js'] combine=true}
